...
class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    var textHeading = TextStyle(color: Colors.black, fontSize: 20); // Text style for the name
    var textStyle = TextStyle(color: Colors.black38); // Text style for everything else
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    mainAxisSize: MainAxisSize.min,
                                    children: <Widget>[
                                      Text('Rutvik chandla', style: textHeading),
                                      Text('@Rutvik308', style: textStyle)
                                    ],
                                  ))),
                            ],
                          )),
